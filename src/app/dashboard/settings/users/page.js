...
return ( <div className="border-border flex items-center gap-3 border-b p-6"> <div className="bg-primary-light text-primary flex h-10 w-10 items-center justify-center rounded-lg"> <Icon size={20} /> </div>
...
return (
<div className={`flex items-center justify-between gap-4 ${compact ? "rounded-xl border border-border p-4" : "p-6"}`}> <div> <p className="text-text text-sm font-semibold">{title}</p> <p className="text-text-secondary mt-1 text-xs leading-5">
{description} </p> </div>
...
return ( <div className="border-border flex flex-col gap-3 border-t pt-5 sm:flex-row sm:justify-end">
<button
type="button"
onClick={() => router.back()}
