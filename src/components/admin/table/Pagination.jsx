...
export default function Pagination({
  ...
  const availablePageSizes = pageSizeOptions.filter(
...
====================================================== */}
  ...
  ====================================================== */}
    ...
    ==================================================== */}
        ...
        <div ref={pageSizeRef} className="relative flex items-center gap-2">
          <span className="text-text-secondary hidden text-xs sm:inline">
            Rows
          </span>
      ...
      ================================================== */}
          ...
          <button
            type="button"
            onClick={() => setPageSizeOpen((previous) => !previous)}
            className="border-border bg-background text-text hover:bg-surface flex h-9 min-w-17 items-center justify-between gap-2 rounded-lg border px-2.5 text-sm transition outline-none"
          >
            <span>{pageSize}</span>
      ...
      ================================================== */}
          ...
          {pageSizeOpen && (
            <div className="border-border bg-background absolute bottom-full left-0 z-50 mb-1.5 min-w-full overflow-hidden rounded-lg border shadow-lg">
              {availablePageSizes.map((size) => (
                <button
                  key={size}
                  type="button"
                  onClick={() => handlePageSize(size)}
                  className={`text-text flex w-full items-center px-3 py-2 text-left text-sm transition ${
                    pageSize === size
