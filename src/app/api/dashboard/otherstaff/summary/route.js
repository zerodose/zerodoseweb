...
if (user.designation !== "otherstaff") {
  return NextResponse.json(
    {
      success: false,
      message: "Only otherstaffs can access otherstaff summary.",
    },
    { status: 403 },
  );
}
...
console.error("otherstaff Summary Error:", error);
...
return NextResponse.json(
  {
    success: false,
    message:
      error?.message || "Failed to get otherstaff summary.",
  },
  { status: 500 },
);
