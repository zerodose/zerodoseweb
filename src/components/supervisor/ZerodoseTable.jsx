...
label: "Recorded",
icon: ClipboardList,
getValue: (team) => Number(team?.recordCount || 0),
},
{
key: "visitCount",
label: "Visited",
icon: Eye,
getValue: (team) => Number(team?.visitCount || 0),
},
{
key: "coveredCount",
label: "Covered",
icon: CheckCircle2,
getValue: (team) => Number(team?.coveredCount || 0),
},
];

return ( <div className="mb-5">
{data.length === 0 ? ( <div className="border-border bg-background rounded-2xl border px-4 py-12 text-center shadow-sm"> <div className="bg-primary/5 text-primary mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl"> <Users size={22} /> </div>
