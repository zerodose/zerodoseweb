...
export default function SupervisorWorkersPage() {
  ...
  return (
    ...
    ====================================================== */}
      ...
      >
        ...
        <div className="relative flex min-w-0 items-center justify-between gap-3 px-3.5 py-3.5 sm:px-5 sm:py-4">
          ...
          <div className="border-primary/20 bg-primary-light text-primary flex w-fit items-center gap-2 rounded-xl border px-4 py-2.5 text-sm font-semibold shadow-sm dark:bg-primary/10 dark:border-primary/30">
            <Users size={18} />
            <span>
              {teams.length} {teams.length === 1 ? "Team" : "Teams"}
            </span>
    ...
    ====================================================== */}
      ...
      {!loading && !error && teams.length === 0 && (
        <div className="border-border bg-background rounded-2xl border p-12 text-center shadow-sm">
          <div className="bg-primary-light mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl dark:bg-primary/10">
            <Users size={26} className="text-primary" />
          </div>
          ...
          {teams.map((team) => {
            ...
            return (
              ...
              ================================================== */}
                ...
                <div className="border-border relative overflow-hidden border-b bg-gradient-to-r from-[#eaf6ff] via-[#f5faff] to-white px-5 py-5 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
                  {/* Decorative circle */}

                  <div className="bg-primary/5 absolute -top-12 -right-8 h-32 w-32 rounded-full dark:bg-primary/10" />
                  ...
                  <div className="relative flex items-center justify-between gap-4 md:flex-row">
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      <span className="border-primary/20 bg-background text-primary rounded-lg border px-3 py-1.5 text-xs font-semibold shadow-sm dark:bg-slate-800 dark:border-primary/30">
                        {team.workers.length}{" "}
                        {team.workers.length === 1 ? "Worker" : "Workers"}
                      </span>
                    </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[1100px]">
                    ...
                    ================================================== */}
                      ...
                      {leader && (
                        <tr className="group border-border hover:bg-primary-light/40 border-b transition-colors dark:hover:bg-primary/5">
                          <td className="px-5 py-4">
                            <span className="bg-primary-light text-primary border-primary/10 inline-flex items-center rounded-lg border px-3 py-1.5 text-xs font-bold dark:bg-primary/10 dark:border-primary/20">
                              Team Leader
                            </span>
                          </td>
                    ...
                    ================================================== */}
                      ...
                      {member && (
                        <tr className="group border-border border-b transition-colors last:border-b-0 hover:bg-slate-50 dark:hover:bg-slate-800/50">
                          <td className="px-5 py-4">
                            <span className="inline-flex items-center rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-bold text-slate-600 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                              Team Member
                            </span>
                          </td>
