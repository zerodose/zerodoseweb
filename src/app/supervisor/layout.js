...
export default function SupervisorLayout({ children }) {
  ...
  const ucCode =
    user?.unionCouncil?.code || user?.unionCouncilId?.code || "";

  const ucName =
    user?.unionCouncil?.name || user?.unionCouncilId?.name || "";

  const ucmoName =
    user?.ucmo?.name || user?.ucmoId?.name || "";
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <main className="flex-1 bg-background p-4 sm:px-4 sm:py-5 md:px-10 md:py-6">
          {/* ==================================================
              Supervisor Header
          ================================================== */}
