...
import PageHeaderForTownDistrictAdmin from "../ui/PageHeaderForTownDistrictAdmin";
...
export default function TownFPHeader({ onMenuClick }) {
  ...
  const districtName = user?.district?.name || user?.districtId?.name || "";

  return (
    <PageHeaderForTownDistrictAdmin
      name={user?.name}
      designation={user?.designation || "Town FP"}
      onMenuClick={onMenuClick}
      dashboardRoute="/townfp"
      townName={townName}
