...
// zerodose.updateData = pendingUpdate;
...
//       if (!zerodose.updateRequested || !zerodose.updateData) {
//         return NextResponse.json(
//           {
//             success: false,
...
//     const pendingUpdate = zerodose.updateData;
...
//     );
//   } catch (error) {
//     console.error("Put Zerodose error:", error);
  ...
  try {
        ...
        return NextResponse.json(
          {
            success: false,
            message:
              "You are not authorized to manage this Zerodose.",
          },
          {
            status: 403,
          },
        ...
        return NextResponse.json(
          {
            success: false,
            message:
              "Supervisor action must be either approve or reject.",
          },
          {
            status: 400,
          },
      ...
      return NextResponse.json(
        {
          success: true,
          message:
            "Update request approved and Zerodose updated successfully.",
          data: populated,
        },
        {
          status: 200,
    ...
    if (user.designation === "vaccinator") {
        ...
        return NextResponse.json(
          {
            success: false,
            message:
              "You are not authorized to update this Zerodose.",
          },
          {
            status: 403,
          },
      ...
      if (body.vaccinationStatus !== undefined) {
        ...
        if (
          !allowedStatuses.includes(body.vaccinationStatus)
        ) {
          return NextResponse.json(
            {
              success: false,
      ...
      return NextResponse.json(
        {
          success: true,
          message:
            "Zerodose status updated successfully.",
          data: populated,
        },
        {
          status: 200,
    ...
    if (user.designation === "ucmo") {
      ...
      if (
        !["approveDelete", "rejectDelete"].includes(action)
      ) {
        return NextResponse.json(
          {
            success: false,
            message:
              "UCMO action must be approveDelete or rejectDelete.",
          },
          {
            status: 400,
          },
      ...
      const deletedZerodose =
        await Zerodose.findByIdAndDelete(id);
      ...
      return NextResponse.json(
        {
          success: true,
          message:
            "Delete request approved. Zerodose deleted successfully.",
          data: {
            _id: deletedZerodose._id,
          },
        },
    ...
    return NextResponse.json(
      {
        success: false,
        message:
          "Failed to process Zerodose update.",
      },
      {
        status: 500,
      },
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "Only supervisors can request Zerodose deletion.",
        },
        {
          status: 403,
        },
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "You are not authorized to delete this Zerodose.",
        },
        {
          status: 403,
        },
      ...
      return NextResponse.json(
        {
          success: false,
          message:
            "A delete request is already pending UCMO approval.",
        },
        {
          status: 409,
        },
    ...
    return NextResponse.json(
      {
        success: true,
        message:
          "Delete request submitted. UCMO approval is required.",
        data: populated,
      },
      {
        status: 200,
