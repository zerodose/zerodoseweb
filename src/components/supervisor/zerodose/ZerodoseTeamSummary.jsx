...
data.forEach((item) => {
  ...
  if (
    !team.teamLeader &&
    item?.user?.workerRole === "teamLeader"
  ) {
  ...
  if (
    !team.teamMember &&
    item?.user?.workerRole === "teamMember"
  ) {
  ...
  if (
    !team.teamLeader &&
    item?.worker?.workerRole === "teamLeader"
  ) {
  ...
  if (
    !team.teamMember &&
    item?.worker?.workerRole === "teamMember"
  ) {
    ...
    <div className="border-border bg-surface mb-4 rounded-xl border p-2">
      <div className="grid grid-cols-3 gap-2">
        ...
        <button
          type="button"
          onClick={() =>
            handleStatusFilterChange("recorded")
          }
        ...
        <button
          type="button"
          onClick={() =>
            handleStatusFilterChange("visited")
          }
          className={`flex items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-xs font-semibold transition-all duration-200 sm:text-sm ${
        ...
        <button
          type="button"
          onClick={() =>
            handleStatusFilterChange("covered")
          }
          className={`flex items-center justify-center gap-2 rounded-lg px-3 py-2.5 text-xs font-semibold transition-all duration-200 sm:text-sm ${
