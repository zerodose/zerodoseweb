    ...
    >
      ...
      >
        <div className="flex min-w-0 items-center gap-3.5">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <p className="text-text truncate text-sm font-semibold capitalize md:text-base">
                {supervisor?.name || "-"}
              </p>
        ...
        <div className="overflow-hidden">
          <div className="border-border border-t">
            <div className="p-4 md:p-5">
              ...
              {isSupervisor && (
                <div className="border-border bg-surface mt-4 rounded-2xl border p-4 md:p-5">
                  <div className="mb-3">
                    ...
                    <p className="text-text-secondary mt-1 text-xs leading-5">
                      Enter a new supervisor code before approving this
                      supervisor. The new code will be assigned to the
                  ...
                  <div className="max-w-md">
                    <label
                      htmlFor={`supervisor-code-${supervisor?._id}`}
                    ...
                    <input
                      id={`supervisor-code-${supervisor?._id}`}
                      type="number"
                      value={supervisorCode}
                      onChange={(e) => setSupervisorCode(e.target.value)}
                      disabled={processing}
                      placeholder="Enter supervisor code"
                      className="border-border bg-background text-text placeholder:text-text-secondary focus:border-primary focus:ring-primary/20 h-10 w-full rounded-xl border px-3 text-sm font-medium transition outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-60"
                    />
