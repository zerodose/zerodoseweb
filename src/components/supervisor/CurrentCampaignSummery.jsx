...
// //         team.recorded = Number(item?.recordCount ?? item?.recorded ?? 0);

// //         team.visited = Number(item?.visitCount ?? item?.visited ?? 0);

// //         team.covered = Number(item?.coveredCount ?? item?.covered ?? 0);
...
//         campaign={campaign}
//         label="CURRENT CAMPAIGN"
//         teams={isSupervisor ? total.numberOfTeams : 0}
//         recorded={isSupervisor ? total.recordCount : 0}
//         visited={isSupervisor ? total.visitCount : 0}
//         covered={isSupervisor ? total.coveredCount : 0}
//       />
...
//       {isSupervisor ? (
//         <ZerodoseTable data={data} loading={loading} />
//       ) : (
//         <SupervisorsTable data={data} loading={loading} />
//       )}
//     </section>
//   );
// }
